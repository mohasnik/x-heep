...
package xheep_obi_to_axi_bridge_pkg;
  ...
  // Default VPK180 DDR AXI view. Override the wrapper type parameters if the
  ...
  localparam logic [VPK180_DDR_AXI_ADDR_WIDTH-1:0] VPK180_DDR_BASE_ADDR =
  ...
  `AXI_TYPEDEF_AW_CHAN_T(vpk180_ddr_axi_aw_t, vpk180_ddr_axi_addr_t,
                         vpk180_ddr_axi_id_t, vpk180_ddr_axi_user_t)
  `AXI_TYPEDEF_W_CHAN_T(vpk180_ddr_axi_w_t, vpk180_ddr_axi_data_t,
                        vpk180_ddr_axi_strb_t, vpk180_ddr_axi_user_t)
  `AXI_TYPEDEF_B_CHAN_T(vpk180_ddr_axi_b_t, vpk180_ddr_axi_id_t,
                        vpk180_ddr_axi_user_t)
  `AXI_TYPEDEF_AR_CHAN_T(vpk180_ddr_axi_ar_t, vpk180_ddr_axi_addr_t,
                         vpk180_ddr_axi_id_t, vpk180_ddr_axi_user_t)
  `AXI_TYPEDEF_R_CHAN_T(vpk180_ddr_axi_r_t, vpk180_ddr_axi_data_t,
                        vpk180_ddr_axi_id_t, vpk180_ddr_axi_user_t)
