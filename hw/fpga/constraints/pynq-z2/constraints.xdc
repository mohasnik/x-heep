create_clock -period 8.000 -name sys_clk_pin -waveform {0.000 5.000} -add [get_ports clk_i]
create_clock -add -name jtag_clk_pin -period 100.00 -waveform {0 5} [get_ports {jtag_tck_i}];
create_clock -period 16.000 -name spi_slave_clk_pin -waveform {0.000 5.000} -add [get_ports spi_slave_sck_io]
