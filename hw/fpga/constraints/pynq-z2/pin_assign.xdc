...
set_property -dict {PACKAGE_PIN M15 IOSTANDARD LVCMOS33} [get_ports {gpio_io[11]}]
set_property -dict {PACKAGE_PIN G14 IOSTANDARD LVCMOS33} [get_ports {gpio_io[12]}]
set_property -dict {PACKAGE_PIN L14 IOSTANDARD LVCMOS33} [get_ports {gpio_io[13]}]

# SPI SLAVE
set_property -dict {PACKAGE_PIN U7 IOSTANDARD LVCMOS33} [get_ports spi_slave_sck_io]
set_property -dict {PACKAGE_PIN V6 IOSTANDARD LVCMOS33} [get_ports spi_slave_cs_io]
set_property -dict {PACKAGE_PIN U13 IOSTANDARD LVCMOS33} [get_ports spi_slave_miso_io]
set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS33} [get_ports spi_slave_mosi_io]
...
set_property -dict {PACKAGE_PIN W9  IOSTANDARD LVCMOS33} [get_ports i2s_sd_io]
