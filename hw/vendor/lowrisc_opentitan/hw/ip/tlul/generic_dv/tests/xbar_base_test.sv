...
class xbar_base_test extends dv_base_test #(
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    void'($value$plusargs("allow_host_drop_valid_wo_ready=%d", cfg.allow_host_drop_valid_wo_ready));
    void'($value$plusargs(
        "allow_device_drop_valid_wo_ready=%d", cfg.allow_device_drop_valid_wo_ready
    ));
