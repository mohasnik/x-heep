...
`endif
  ...
  task automatic check_encryption(
      input bit [DataWidth-1:0] plaintext, input bit [KeyWidth-1:0] key,
  ...
  // Calls a subroutine to perform checks on the outputs (once they are available).
  task automatic check_decryption(input bit [1:0][1:0][NumRoundsHalf-1:0][DataWidth-1:0] ciphertext,
  ...
  task automatic check_output(
      ...
      input bit [1:0][NumRoundsHalf-1:0][DataWidth-1:0] actual_text_new_sched, input string msg);
