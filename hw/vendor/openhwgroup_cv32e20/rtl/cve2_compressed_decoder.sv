...
module cve2_compressed_decoder (
  ...
  `ASSERT(CVE2InstrLSBsKnown, valid_i |-> !$isunknown(instr_i[1:0]))
  `ASSERT(CVE2C0Known1, (valid_i && (instr_i[1:0] == 2'b00)) |-> !$isunknown(instr_i[15:13]))
  `ASSERT(CVE2C1Known1, (valid_i && (instr_i[1:0] == 2'b01)) |-> !$isunknown(instr_i[15:13]))
  `ASSERT(CVE2C1Known2,
  ...
  `ASSERT(
      ...
      ({instr_i[12], instr_i[6:5]}))
  `ASSERT(CVE2C2Known1, (valid_i && (instr_i[1:0] == 2'b10)) |-> !$isunknown(instr_i[15:13]))
