...
`endif
  ...
  `ASSERT_KNOWN_IF(CVE2DataReqPayloadX, {data_we_o, data_be_o, data_addr_o, data_wdata_o},
                   data_req_o)
  ...
  `ASSERT_KNOWN_IF(CVE2InstrRPayloadX, {instr_rdata_i, instr_err_i}, instr_rvalid_i)
