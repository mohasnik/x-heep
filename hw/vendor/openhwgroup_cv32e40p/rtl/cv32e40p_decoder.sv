        ...
        if (instr_rdata_i[31:30] == 2'b11) begin
          ...
          if (instr_rdata_i[29:25] == 5'b00000) begin
            ...
            if (FPU == 1 && C_XFVEC == 1) begin
                  ...
                  unique case (instr_rdata_i[24:20]) inside
                    ...
                    5'b0001?: begin
                      ...
                      unique case (instr_rdata_i[13:12])
                        ...
                        // FP16[ALT]
                        2'b01, 2'b10: fpu_int_fmt_o = cv32e40p_fpu_pkg::INT16;
                        // FP8
              ...
              if ((~C_RVF || ~C_RVD) && fpu_dst_fmt_o == cv32e40p_fpu_pkg::FP32)
                illegal_insn_o = 1'b1;
              // need RVF for F16 vectors
              if ((~C_XF16 || ~C_RVF) && fpu_dst_fmt_o == cv32e40p_fpu_pkg::FP16)
                illegal_insn_o = 1'b1;
              // need RVF for F16 vectors
