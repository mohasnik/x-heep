...
(
  ...
  else `uvm_error("sleep_unit", "Assertion a_clock_en_0 failed")
  ...
  else `uvm_error("sleep_unit", "Assertion a_clock_en_1 failed")
  ...
  else `uvm_error("sleep_unit", "Assertion a_clock_en_2 failed")
  ...
  else `uvm_error("sleep_unit", "Assertion a_clock_en_4 failed")
  ...
  else `uvm_error("sleep_unit", "Assertion a_clock_en_5 failed")
  ...
  else `uvm_error("sleep_unit", "Assertion a_core_sleep failed")
  ...
  else `uvm_error("sleep_unit", "Assertion a_non_busy failed")
  ...
  else `uvm_error("sleep_unit", "Assertion a_gate_clk_i failed")
  ...
  a_only_sleep_for_wfi_wfe :
  assert property (p_only_sleep_for_wfi_wfe)
