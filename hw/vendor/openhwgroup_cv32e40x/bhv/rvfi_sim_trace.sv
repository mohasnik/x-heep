...
#(
  ...
  localparam trace_t TRACE_UNKNOWN = '{
      c_func : "NA",
      c_file : "NA",
      c_line : -1,
      addr   : 'x,
      ...
      if (ITRACE_ENABLE) begin
        ...
        initial begin
          ...
          if (!$value$plusargs({LOGFILE_PATH_PLUSARG, "=%s"}, logfilename)) begin
            $display(
                $sformatf(
                    "Not generating instruction trace log file, please supply +%0s=<PATH> if desired.",
                    LOGFILE_PATH_PLUSARG));
            ...
            if (enable_log_write == 1'b1) begin
              ...
              if (logfile == 0) begin
                ...
                $fdisplay(logfile, {$sformatf
                                    ("%-10s | %-3s (%-10s) | %-3s (%-10s) | %-3s (%-10s) | ", "pc",
                                     "rs1", "   data", "rs2", "   data", "rd", "   data"),
            ...
            if (file == 0) begin
              ...
              while ($fgets(
                ...
                if (line[0] != "#") begin
                  ...
                  elements_found = $sscanf(
                      line,
                      "%d %s %s %d %h %d %s %s %s %s %s",
                      tmp_trace.addr,
                      tmp_trace.c_func,
                      tmp_trace.c_file,
                      tmp_trace.c_line,
