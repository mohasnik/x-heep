...
module rvb_zbb32 (
  ...
  always @* begin
    dout_bitcnt = 0;
    for (i = 0; i < 32; i = i + 1) dout_bitcnt[5:0] = dout_bitcnt[5:0] + bitcnt_bits[i];
  end
  ...
  wire shift_ones = din_insn[30:29] == 2'b01;
  wire shift_arith = din_insn[30:29] == 2'b10;
  wire shift_rot = din_insn[30:29] == 2'b11;
  wire shift_none = din_insn[27];

  wire shift_op_rev = din_insn[27] && shamt[3:2] == 2'b11;
  wire shift_op_rev8 = din_insn[27] && shamt[3:2] == 2'b10;
  wire shift_op_orc_b = din_insn[27] && shamt[3:2] == 2'b01;
...
module rvb_zbb32_decoder (
  ...
  always @* begin
    ...
    (* parallel_case *)
    casez (insn)
      32'b0100000_zzzzz_zzzzz_111_zzzzz_0110011: insn_opneg = 1;  // ANDN
      32'b0100000_zzzzz_zzzzz_110_zzzzz_0110011: insn_opneg = 1;  // ORN
      32'b0100000_zzzzz_zzzzz_100_zzzzz_0110011: insn_opneg = 1;  // XNOR

      32'b0000000_zzzzz_zzzzz_001_zzzzz_0110011: insn_shift = 1;  // SLL
      32'b0000000_zzzzz_zzzzz_101_zzzzz_0110011: insn_shift = 1;  // SRL
      32'b0100000_zzzzz_zzzzz_101_zzzzz_0110011: insn_shift = 1;  // SRA
      32'b0010000_zzzzz_zzzzz_001_zzzzz_0110011: insn_shift = 1;  // SLO
      32'b0010000_zzzzz_zzzzz_101_zzzzz_0110011: insn_shift = 1;  // SRO
      32'b0110000_zzzzz_zzzzz_001_zzzzz_0110011: insn_shift = 1;  // ROL
      32'b0110000_zzzzz_zzzzz_101_zzzzz_0110011: insn_shift = 1;  // ROR

      32'b00000_00zzzzz_zzzzz_001_zzzzz_0010011: insn_shift = 1;  // SLLI
      32'b00000_00zzzzz_zzzzz_101_zzzzz_0010011: insn_shift = 1;  // SRLI
      32'b01000_00zzzzz_zzzzz_101_zzzzz_0010011: insn_shift = 1;  // SRAI
      32'b00100_00zzzzz_zzzzz_001_zzzzz_0010011: insn_shift = 1;  // SLOI
      32'b00100_00zzzzz_zzzzz_101_zzzzz_0010011: insn_shift = 1;  // SROI
      32'b01100_00zzzzz_zzzzz_101_zzzzz_0010011: insn_shift = 1;  // RORI

      32'b01101_0011111_zzzzz_101_zzzzz_0010011: insn_shift = 1;  // REV
      32'b01101_0011000_zzzzz_101_zzzzz_0010011: insn_shift = 1;  // REV8
      32'b00101_0000111_zzzzz_101_zzzzz_0010011: insn_shift = 1;  // ORC.B

      32'b0110000_00000_zzzzz_001_zzzzz_0010011: insn_bitcnt = 1;  // CLZ
      32'b0110000_00001_zzzzz_001_zzzzz_0010011: insn_bitcnt = 1;  // CTZ
      32'b0110000_00010_zzzzz_001_zzzzz_0010011: insn_bitcnt = 1;  // PCNT

      32'b0000101_zzzzz_zzzzz_100_zzzzz_0110011: insn_minmax = 1;  // MIN
      32'b0000101_zzzzz_zzzzz_101_zzzzz_0110011: insn_minmax = 1;  // MAX
      32'b0000101_zzzzz_zzzzz_110_zzzzz_0110011: insn_minmax = 1;  // MINU
      32'b0000101_zzzzz_zzzzz_111_zzzzz_0110011: insn_minmax = 1;  // MAXU

      32'b0000100_zzzzz_zzzzz_100_zzzzz_0110011: insn_pack = 1;  // PACK
    endcase
  end
endmodule
