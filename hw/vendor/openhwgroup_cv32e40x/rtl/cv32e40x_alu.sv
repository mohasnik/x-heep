...
#(
  ...
  always_comb begin
    ...
    unique case (operator_i)
      ...
      ALU_B_ROL, ALU_B_ROR: begin
        shifter_bb = operand_a_i;
      end
      ALU_B_BSET, ALU_B_BCLR, ALU_B_BINV: begin
        shifter_aa = 32'h1;
      end
      default: ;
    endcase
  ...
  assign is_greater = $signed(
      {operand_a_i[31] & is_signed, operand_a_i}
  ) > $signed(
      {operand_b_i[31] & is_signed, operand_b_i}
  );
  ...
  always_comb begin
    ...
    unique case (operator_i)
      ...
      // Shift and add
      ALU_B_SH1ADD, ALU_B_SH2ADD, ALU_B_SH3ADD: result_o = result_shnadd;
      ...
      ALU_B_REV8:
      result_o = {operand_a_i[7:0], operand_a_i[15:8], operand_a_i[23:16], operand_a_i[31:24]};
