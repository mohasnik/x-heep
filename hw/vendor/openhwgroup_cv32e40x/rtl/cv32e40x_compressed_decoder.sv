      ...
      unique case (instr[1:0])
        ...
        2'b00: begin
          unique case (instr[15:13])
            ...
            3'b001, 3'b011,  // c.flw -> flw rd', imm(rs1')
            3'b101, 3'b111: begin  // c.fsw -> fsw rs2', imm(rs1')
              illegal_instr_o = 1'b1;
              instr_o.bus_resp.rdata = {
                5'b0,
                instr[5],
        ...
        2'b01: begin
          unique case (instr[15:13])
            3'b000: begin
              ...
              // c.nop
              instr_o.bus_resp.rdata = {
                {6{instr[12]}}, instr[12], instr[6:2], instr[11:7], 3'b0, instr[11:7], OPCODE_OPIMM
              };
            end
            ...
            3'b010: begin
              if (instr[11:7] == 5'b0) begin
                ...
                instr_o.bus_resp.rdata = {
                  {6{instr[12]}}, instr[12], instr[6:2], 5'b0, 3'b0, instr[11:7], OPCODE_OPIMM
                };
              end else begin
                      ...
                      if (ZC_EXT) begin
                        unique case (instr[4:2])
                          ...
                          3'b101: begin
                            ...
                            instr_o.bus_resp.rdata = {
                              12'hfff, 2'b01, instr[9:7], 3'b100, 2'b01, instr[9:7], OPCODE_OPIMM
                            };
                          end
                          default: begin
                            instr_o.bus_resp.rdata = {
          ...
          unique case (instr[15:13])
            3'b000: begin
              if (instr[12] == 1'b1) begin
                ...
                instr_o.bus_resp.rdata = {
                  7'b0, instr[6:2], instr[11:7], 3'b001, instr[11:7], OPCODE_OPIMM
                };
                illegal_instr_o = 1'b1;
              end else begin
              ...
              if (instr[12] == 1'b0) begin
                if (instr[6:2] == 5'b0) begin
                  if (instr[11:7] == 5'b0) begin
                    ...
                    };  // Not using OPCODE_JALR on purpose (to allow direct decoder_i_ctrl branch/jump usage)
                    illegal_instr_o = 1'b1;
                  end else begin
            ...
            3'b001, 3'b011, 3'b101, 3'b111: begin  // c.fswsp -> fsw rs2, imm(x2)
              instr_o.bus_resp.rdata = {
                4'b0,
                instr[3:2],
                instr[12],
