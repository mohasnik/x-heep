    ...
    unique case (instr_rdata_i[6:0])
      ...
      OPCODE_OPIMM: begin  // Register-Immediate ALU Operations
        ...
        unique case (instr_rdata_i[14:12])
          ...
          3'b011:
          decoder_ctrl_o.alu_operator = ALU_SLTU;  // Set to one if Lower Than Immediate Unsigned
      ...
      OPCODE_OP: begin  // Register-Register ALU operation
        if ((instr_rdata_i[31:30] == 2'b11) || (instr_rdata_i[31:30] == 2'b10)) begin
          ...
          unique case ({
            ...
            decoder_ctrl_o.alu_operator = ALU_SLTU;  // Set Lower Than Unsigned
      ...
      OPCODE_SYSTEM: begin
        if (instr_rdata_i[14:12] == 3'b000) begin  // Non CSR related SYSTEM instructions
          ...
          unique case (instr_rdata_i[13:12])
            ...
            2'b10:
            decoder_ctrl_o.csr_op = (instr_rdata_i[19:15] == 5'b0) ? CSR_OP_READ : CSR_OP_SET;
            2'b11:
            decoder_ctrl_o.csr_op = (instr_rdata_i[19:15] == 5'b0) ? CSR_OP_READ : CSR_OP_CLEAR;
