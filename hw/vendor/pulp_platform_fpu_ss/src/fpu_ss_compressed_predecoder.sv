  ...
  always_comb begin
    ...
    unique casez (prd_req_i.comp_instr)
      fpu_ss_instr_pkg::C_FLW: begin
        ...
        prd_rsp_o.decomp_instr = {
          5'b0,
          prd_req_i.comp_instr[5],
          prd_req_i.comp_instr[12:10],
          prd_req_i.comp_instr[6],
          2'b00,
          2'b01,
          prd_req_i.comp_instr[9:7],
          3'b010,
          2'b01,
          prd_req_i.comp_instr[4:2],
          7'b000_0111
        };
      end
      fpu_ss_instr_pkg::C_FLWSP: begin
        ...
        prd_rsp_o.decomp_instr = {
          4'b0,
          prd_req_i.comp_instr[3:2],
          prd_req_i.comp_instr[12],
          prd_req_i.comp_instr[6:4],
          2'b00,
          5'h02,
          3'b010,
          prd_req_i.comp_instr[11:7],
          7'b000_0111
        };
      end
      ...
      fpu_ss_instr_pkg::C_FSWSP: begin
        ...
        prd_rsp_o.decomp_instr = {
          4'b0,
          prd_req_i.comp_instr[8:7],
          prd_req_i.comp_instr[12],
          prd_req_i.comp_instr[6:2],
          5'h02,
          3'b010,
          prd_req_i.comp_instr[11:9],
          2'b00,
          7'b010_0111
        };
      end
