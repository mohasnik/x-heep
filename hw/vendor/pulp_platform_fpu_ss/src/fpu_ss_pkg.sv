...
package fpu_ss_pkg;
  ...
  typedef struct packed {logic [15:0] comp_instr;} comp_prd_req_t;
  ...
  typedef struct packed {logic [31:0] q_instr_data;} acc_prd_req_t;
  ...
  parameter fpnew_pkg::fpu_features_t FPU_FEATURES = '{
      ...
      FpFmtMask: {
        ...
        fpu_ss_pkg::C_XF16,
        fpu_ss_pkg::C_XF8,
        fpu_ss_pkg::C_XF16ALT
      },
      IntFmtMask: {
        fpu_ss_pkg::C_XFVEC && fpu_ss_pkg::C_XF8,
        fpu_ss_pkg::C_XFVEC && (fpu_ss_pkg::C_XF16 || fpu_ss_pkg::C_XF16ALT),
        1'b1,
        1'b0
      }
  };
  ...
  parameter fpnew_pkg::fpu_implementation_t FPU_IMPLEMENTATION = '{
      PipeRegs: '{  // FP32, FP64, FP16, FP8, FP16alt
          '{
              fpu_ss_pkg::C_LAT_FP32,
              fpu_ss_pkg::C_LAT_FP64,
              fpu_ss_pkg::C_LAT_FP16,
              fpu_ss_pkg::C_LAT_FP8,
              fpu_ss_pkg::C_LAT_FP16ALT
          },  // ADDMUL
